...
execute if score $selected_dialogue daegl_temp matches 0 run tellraw @s [{"text": "[","color": "yellow"},{"text": "Fidelan Merchant","color": "gold"}, {"text": "] Get your Miner's Brew here!"}]
execute if score $selected_dialogue daegl_temp matches 1 run tellraw @s [{"text": "[","color": "yellow"},{"text": "Fidelan Merchant","color": "gold"}, {"text": "] Only slightly alcoholic!"}]
