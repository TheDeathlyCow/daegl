...
execute if data storage daegl:inventory temp_restore run item replace entity @s armor.feet from entity @e[tag=daegl_inventory_marker,limit=1] armor.feet
...
execute if data storage daegl:inventory temp_restore as @e[tag=daegl_inventory_marker,limit=1] run function daegl:dungeon/io/inventory/_private/set_armor_stand_feet
execute if data storage daegl:inventory temp_restore run item replace entity @s armor.legs from entity @e[tag=daegl_inventory_marker,limit=1] armor.feet
...
execute if data storage daegl:inventory temp_restore as @e[tag=daegl_inventory_marker,limit=1] run function daegl:dungeon/io/inventory/_private/set_armor_stand_feet
execute if data storage daegl:inventory temp_restore run item replace entity @s armor.chest from entity @e[tag=daegl_inventory_marker,limit=1] armor.feet
...
execute if data storage daegl:inventory temp_restore as @e[tag=daegl_inventory_marker,limit=1] run function daegl:dungeon/io/inventory/_private/set_armor_stand_feet
execute if data storage daegl:inventory temp_restore run item replace entity @s armor.head from entity @e[tag=daegl_inventory_marker,limit=1] armor.feet
