...
tellraw @s ""
tellraw @a [{"text": "","color": "red"},{"text": "[!!] ", "color": "gold", "bold": false},{"selector": "@s", "color": "gold", "bold": true}, " has entered the Mines of Daegl! All party members have ", {"score": {"name":"seconds_to_enter", "objective": "daegl.temp"}, "color": "gold", "bold": true}, " seconds to join before the gates close", {"text": " [!!]", "color": "gold", "bold": false}]
